...
const GlassIcosahedron = dynamic(() => import('@/components/ui/GlassIcosahedron'), {
  ssr: false,
  loading: () => (
    <div className="w-full h-[400px] md:h-[500px] bg-slate-900/30 rounded-xl flex items-center justify-center border border-fuchsia-500/20">
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-fuchsia-500/10 via-purple-500/10 to-orange-500/10" />
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-fuchsia-500/20 rounded-full blur-3xl animate-pulse will-change-transform" />
        <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-pulse delay-1000 will-change-transform" />
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                <span className="bg-gradient-to-r from-fuchsia-400 via-purple-500 to-orange-500 bg-clip-text text-transparent">
                  Ingeniería Digital
                </span>
                <br />
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
                <Link
                  href="/contacto"
                  className="px-8 py-4 bg-gradient-to-r from-fuchsia-500 to-purple-600 rounded-lg font-semibold text-white hover:from-fuchsia-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-fuchsia-500/25"
                >
                  Comienza tu Proyecto
                </Link>
                <Link
                  href="/servicios"
                  className="px-8 py-4 bg-slate-800/50 backdrop-blur-sm border border-fuchsia-500/30 rounded-lg font-semibold text-white hover:bg-slate-700/50 hover:border-fuchsia-500/50 transition-all duration-300"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <Link
                href="/acerca"
                className="inline-flex items-center text-fuchsia-400 hover:text-fuchsia-300 font-semibold transition-colors"
              >
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-fuchsia-500/20 to-purple-500/20 rounded-2xl blur-2xl" />
              <div className="relative bg-slate-800/50 backdrop-blur-sm border border-fuchsia-500/20 rounded-2xl p-8">
                <div className="grid grid-cols-2 gap-6">
                  <div className="text-center">
                    <div className="text-4xl font-bold bg-gradient-to-r from-fuchsia-400 to-purple-500 bg-clip-text text-transparent mb-2">
                      100+
                    </div>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-r from-fuchsia-500/10 via-purple-500/10 to-orange-500/10 backdrop-blur-sm border border-fuchsia-500/20 rounded-2xl p-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
            ...
            <Link
              href="/contacto"
              className="inline-block px-8 py-4 bg-gradient-to-r from-fuchsia-500 to-purple-600 rounded-lg font-semibold text-white hover:from-fuchsia-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg shadow-fuchsia-500/25"
            >
              Contáctanos Hoy
            </Link>
          </div>
